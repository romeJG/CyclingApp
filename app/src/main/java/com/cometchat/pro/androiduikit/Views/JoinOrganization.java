...
import static com.cometchat.pro.androiduikit.Helpers.Utils.showProgressBar;
...
public class JoinOrganization extends AppCompatActivity
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel>
                ...
                if(response == null || response.body() == null){
                    showInfoDialog(JoinOrganization.this,"ERROR","Response or Response Body is null. \n Recheck Your PHP code.");
                    return;
                }
                ...
                if (currentPageScientists != null && currentPageScientists.size() > 0) {
                    ...
                    show(JoinOrganization.this,"Hey! Reached End. No more Found");
                }
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(JoinOrganization.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_new:
                Utils.openActivity(this, CreateGroup.class);
                finish();
                return true;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupRecyclerView();
        retrieveAndFillRecyclerView("TESTING_1", "", "0", "5", "");
    }
}
