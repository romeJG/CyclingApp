...
public class Record extends AppCompatActivity
        ...
        retrievedData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel>
                ...
                if(response == null || response.body() == null){
                    showInfoDialog(Record.this,"ERROR","Response or Response Body is null. \n Recheck Your PHP code.");
                    return;
                }
                ...
                if (currentPageScientists != null && currentPageScientists.size() > 0) {
                    ...
                    show(Record.this,"Hey! Reached End. No more Found");
                }
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                ...
                Utils.showInfoDialog(Record.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(Record.this); //TINITIGNAN KUNG MAY SESSION
        ...
        setupRecyclerView();
        retrieveAndFillRecyclerView("RECORDS", "", "0", "5", "");
    }
    private void moveToLogin() {
        sessionManager.logoutSession();
        Intent intent = new Intent(Record.this, Login1.class);
